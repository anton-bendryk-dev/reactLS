    ...
    return (
        <div className="header-contacts">
			...
			<div className="col-width-25 header-links">
				<div className='col-height-50 pn'><a href='https://www.facebook.com/companylogisticssolutions/'>Мы в Facebook</a></div> 
				<div className='col-height-50 pn'><a href='https://mail.ukr.net/desktop#sendmsg'>logistics-solutions@ukr.net</a></div>
			</div>	
		</div>
    )
}
